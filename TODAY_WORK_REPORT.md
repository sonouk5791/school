...
## 자동 저장 / 2026-09-22 12:37:37 — 캐릭터 음성 중복 원인 수정 및 실제 voiceURI 진단
- **수행 내역**: 여성 음성 공통 fallback 제거, 캐릭터별 URI 저장과 provider 통합, 선생님 음성 테스트 추가. Edge 한국어 음성은 Heami 1개로 토리만 배정, 나머지 3명은 미배정 안내. 1/2/4개 mock 음성 테스트 및 변경 JS 문법 검사 통과. 상세 documents/CHARACTER_VOICE_DIAGNOSIS_2026-09-22.md. 실제 네 음성 제공은 추가 음성 또는 외부 TTS 인증 필요.

## 자동 저장 / 2026-09-22 13:46:48 — 사용자 지정 캐릭터 음성 매핑 저장
- **수행 내역**: 콩이 Achird, 토리 Aoede, 나비 Gacrux, 보리 Charon 고정 설정. profiles voiceId 및 외부 provider 기본 voiceIds 연결. 선생님 테스트에 지정 음성과 실제 음성 구분 표시. JS 문법 및 음성 회귀 테스트 통과. Gemini 합성 서버/인증은 아직 미연결이며 실제 재생 완료로 표시하지 않음.

## 자동 저장 / 2026-09-22 13:50:13 — 첨부 WAV 4개 캐릭터 연결
- **수행 내역**: 사용자 확인 순서대로 콩이/Achird, 토리/Aoede, 나비/Gacrux, 보리/Charon 원본 WAV 복사. 공통 녹음 재생과 인사/테스트 버튼 연결, 새 문장 TTS 분리. Edge WAV 4개 디코딩, 중복 클릭, 재생 취소, 콘솔 검사 통과. 기존 이미지·활동·녹음 보존. TTS 서버/환경변수 연결 방법은 documents/CHARACTER_RECORDINGS_2026-09-22.md 기록.
...
## 자동 저장 / 2026-09-22 14:16:12 — Vertex AI Gemini 3.1 Flash TTS 서버 구현 및 Production 진단
- **수행 내역**: 기존 Production /api/tts 404 및 환경변수0개 확인. api/tts.js Vertex REST/OAuth/서버 voice매핑/PCM-WAV 추가, 공통음성 POST 연결, 진단테스트 갱신. 모의 서버/브라우저 테스트 및 Vercel build 통과. Production 배포 READY 후 네 캐릭터 POST는 인증 환경변수 미설정으로 모두503. 실제 네 음성 재생 완료 아님. documents/VERTEX_TTS_PRODUCTION_2026-09-22.md에 환경변수/IAM/ADC명령 분석 기록.

## 자동 저장 / 2026-09-22 14:41:36 — Google Vertex TTS Production OIDC 인증 연결
- **수행 내역**: 조직 정책으로 JSON 키 생성 차단 확인. 정책 유지하고 사용자 승인된 Vercel school Production 전용 Workload Identity Federation 설정. roles/aiplatform.user 및 한정된 workloadIdentityUser 적용. 비공개 키 없이 STS/IAM Credentials 인증. 네 캐릭터 Production API 모두 200, 24kHz WAV 생성 4/4 성공. 서버 및 브라우저 회귀 테스트 통과. 상세: documents/VERTEX_TTS_PRODUCTION_2026-09-22.md

## 자동 저장 / 2026-09-22 14:42:31 — Production 네 캐릭터 실제 음성 재생 검증 완료
- **수행 내역**: Achird/Aoede/Gacrux/Charon API 4/4 WAV 성공에 이어 실제 운영 브라우저에서도 네 캐릭터 Google 음성 재생 완료 확인. 콘솔 오류 없음. 음소거 안내를 한국어로 개선. 기존 캐릭터/활동/기록 보존.
...
- [documents/CHARACTER_RECORDINGS_2026-09-22.md](./documents/CHARACTER_RECORDINGS_2026-09-22.md)
- [documents/CHARACTER_VOICE_DIAGNOSIS_2026-09-22.md](./documents/CHARACTER_VOICE_DIAGNOSIS_2026-09-22.md)
- [documents/CHARACTER_VOICE_SETUP.md](./documents/CHARACTER_VOICE_SETUP.md)
- [documents/HERO_SHARED_CLASSROOM_2026-09-22.md](./documents/HERO_SHARED_CLASSROOM_2026-09-22.md)
- [documents/VERTEX_TTS_PRODUCTION_2026-09-22.md](./documents/VERTEX_TTS_PRODUCTION_2026-09-22.md)
- [index.html](./index.html)
- [js/animated-character.js](./js/animated-character.js)
- [js/care-workflow.js](./js/care-workflow.js)
...
- [js/voice.js](./js/voice.js)
- [nabi-learn.html](./nabi-learn.html)
- [scripts/check-production-tts.cjs](./scripts/check-production-tts.cjs)
- [scripts/sync-release.cjs](./scripts/sync-release.cjs)
- [senior-exercise.html](./senior-exercise.html)
...
- [tests/vertex-oidc.cjs](./tests/vertex-oidc.cjs)
- [tests/vertex-tts-browser.cjs](./tests/vertex-tts-browser.cjs)
- [tests/vertex-tts.cjs](./tests/vertex-tts.cjs)
- [tori-play.html](./tori-play.html)
