...
## 사용자 첨부 캐릭터 교체 (최신 표시 기준)
- 사용자가 첨부한 1122×1402 투명 PNG 원본을 편집/재생성하지 않고 assets/images/chuseok/{id}-hanbok-v2.png로 복사.
- 첨부 (3)=콩이 강아지, 오전10_20_47 (4)=토리 토끼, (2)=나비 고양이, (1)=보리 곰.
- 메인/네 방 시작 화면/활동 중 안내에 동일 원본 적용. 기존 hanbok.png와 공식 과거 자산은 보존.
- SVG viewBox 1122×1402, 절하기 회전축 x561 및 y1110/1110/1080/1030(콩이/토리/나비/보리)로 조정. 기존 각도·시간·1회 인사·링크·음성 유지.
