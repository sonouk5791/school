...
$('.site-header').insertAdjacentHTML('beforeend',`<nav class="care-nav" aria-label="프로그램 관리" style="display:none;">${[['home','어르신 홈'],['dashboard','대시보드'],['elders','어르신 관리'],['lessons','오늘의 AI 수업'],['records','수업 기록'],['journals','AI 수업일지'],['analysis','변화 분석'],['reports','보호자 보고서'],['admin','관리자 설정']].map(([id,label])=>btn(label,'nav',id)).join('')}<a class="care-btn" href="character-voice-test.html">캐릭터 음성 테스트</a></nav>`);
