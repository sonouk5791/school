...
document.addEventListener('DOMContentLoaded',()=>{
 ...
 const homeButton=document.createElement('button');homeButton.type='button';homeButton.className='care-btn';homeButton.id='openGuidedExercise';homeButton.textContent='콩이와 영상 보며 20분 체조';
